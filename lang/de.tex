...
\newcommand{\companyTutorPhrase}{Betreuer der Ausbildungsfirma}%

\newcommand{\tutorPhrase}{Betreuer*in des Dualen Partners}
\newcommand{\evaluatorPhrase}{Gutachter*in der Dualen Hochschule}
