...
\newcommand{\defineColors}{%
	...
	\definecolor{ListingBorder}{HTML}{DDDDDD}
...
\newcommand{\listingsettings}{%
	\lstset{%
		...
		xleftmargin=0.05\textwidth,		        % margin left
		xrightmargin=0.05\textwidth,		        % margin right
		frame=single,			        % border settings
		frameround=ffff,
		rulecolor=\color{ListingBorder},	% border color
